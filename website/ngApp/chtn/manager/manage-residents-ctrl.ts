            ...
            this.residentGridOptions =
                {
                    ...
                    [
                        ...
                        { field: 'unitGridLabel', displayName: AppConfig.appShortName === 'condo' ? 'Unit' : 'Home', cellClass: "resident-cell-unit", width: this.showIsRenter ? 62 : 175, sortingAlgorithm: function( a:string, b:string ) { return a.toString().localeCompare( b.toString() ); } },
